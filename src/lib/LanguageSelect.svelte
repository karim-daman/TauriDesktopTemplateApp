...
{#if isDropdownOpen}
  <div in:scale={{ duration: 100, start: 0.95 }} out:scale={{ duration: 75, start: 0.95 }} class="absolute mx-1 top-8 z-10 bg-white p-0.5 divide-gray-100 rounded-lg shadow w-24">
    {#each locales as l}
